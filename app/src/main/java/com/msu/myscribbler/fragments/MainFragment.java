...
public class MainFragment extends Fragment {
    ...
    static class SamplePagerItem {
        ...
        Fragment createFragment(int i) {
        	switch(i){
    		case 0:
    			return HomeFragment.newInstance(mTitle, mIndicatorColor, mDividerColor);
    		
    		case 1:
    			return InfoFragment.newInstance(mTitle, mIndicatorColor, mDividerColor);
    			
    		case 2:
    			return GalleryFragment.newInstance(mTitle, mIndicatorColor, mDividerColor);
